...
static void avx_transpose(Matrix *dst, const Matrix *src)
{
    ...
    for (int x = 0; x < w; x += 8) {
        for (int y = 0; y < h; y += 8) {
            __m256i I0 = _mm256_lddqu_si256((__m256i *)(PRIV(src) + (y + 0) * w + x));
            __m256i I1 = _mm256_lddqu_si256((__m256i *)(PRIV(src) + (y + 1) * w + x));
            __m256i I2 = _mm256_lddqu_si256((__m256i *)(PRIV(src) + (y + 2) * w + x));
            __m256i I3 = _mm256_lddqu_si256((__m256i *)(PRIV(src) + (y + 3) * w + x));
            __m256i I4 = _mm256_lddqu_si256((__m256i *)(PRIV(src) + (y + 4) * w + x));
            __m256i I5 = _mm256_lddqu_si256((__m256i *)(PRIV(src) + (y + 5) * w + x));
            __m256i I6 = _mm256_lddqu_si256((__m256i *)(PRIV(src) + (y + 6) * w + x));
            __m256i I7 = _mm256_lddqu_si256((__m256i *)(PRIV(src) + (y + 7) * w + x));
