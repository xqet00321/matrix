...
static void avx_set_transpose(Matrix *dst, const Matrix *src)
{
    ...
    for (int x = 0; x < w; x += 8) {
        for (int y = 0; y < h; y += 8) {
            __m256i I0 = _mm256_set_epi32(*(int *) ((PRIV(src) + (y + 0) * w + (x+7))),
                                            *(int *) ((PRIV(src) + (y + 0) * w + (x+6))),
                                            *(int *) ((PRIV(src) + (y + 0) * w + (x+5))),
                                            *(int *) ((PRIV(src) + (y + 0) * w + (x+4))),
                                            *(int *) ((PRIV(src) + (y + 0) * w + (x+3))),
                                            *(int *) ((PRIV(src) + (y + 0) * w + (x+2))),
                                            *(int *) ((PRIV(src) + (y + 0) * w + (x+1))),
                                            *(int *) ((PRIV(src) + (y + 0) * w + (x+0))));
            __m256i I1 = _mm256_set_epi32(*(int *) ((PRIV(src) + (y + 1) * w + (x+7))),
                                            *(int *) ((PRIV(src) + (y + 1) * w + (x+6))),
                                            *(int *) ((PRIV(src) + (y + 1) * w + (x+5))),
                                            *(int *) ((PRIV(src) + (y + 1) * w + (x+4))),
                                            *(int *) ((PRIV(src) + (y + 1) * w + (x+3))),
                                            *(int *) ((PRIV(src) + (y + 1) * w + (x+2))),
                                            *(int *) ((PRIV(src) + (y + 1) * w + (x+1))),
                                            *(int *) ((PRIV(src) + (y + 1) * w + (x+0))));
            __m256i I2 = _mm256_set_epi32(*(int *) ((PRIV(src) + (y + 2) * w + (x+7))),
                                            *(int *) ((PRIV(src) + (y + 2) * w + (x+6))),
                                            *(int *) ((PRIV(src) + (y + 2) * w + (x+5))),
                                            *(int *) ((PRIV(src) + (y + 2) * w + (x+4))),
                                            *(int *) ((PRIV(src) + (y + 2) * w + (x+3))),
                                            *(int *) ((PRIV(src) + (y + 2) * w + (x+2))),
                                            *(int *) ((PRIV(src) + (y + 2) * w + (x+1))),
                                            *(int *) ((PRIV(src) + (y + 2) * w + (x+0))));
            __m256i I3 = _mm256_set_epi32(*(int *) ((PRIV(src) + (y + 3) * w + (x+7))),
                                            *(int *) ((PRIV(src) + (y + 3) * w + (x+6))),
                                            *(int *) ((PRIV(src) + (y + 3) * w + (x+5))),
                                            *(int *) ((PRIV(src) + (y + 3) * w + (x+4))),
                                            *(int *) ((PRIV(src) + (y + 3) * w + (x+3))),
                                            *(int *) ((PRIV(src) + (y + 3) * w + (x+2))),
                                            *(int *) ((PRIV(src) + (y + 3) * w + (x+1))),
                                            *(int *) ((PRIV(src) + (y + 3) * w + (x+0))));
            __m256i I4 = _mm256_set_epi32(*(int *) ((PRIV(src) + (y + 4) * w + (x+7))),
                                            *(int *) ((PRIV(src) + (y + 4) * w + (x+6))),
                                            *(int *) ((PRIV(src) + (y + 4) * w + (x+5))),
                                            *(int *) ((PRIV(src) + (y + 4) * w + (x+4))),
                                            *(int *) ((PRIV(src) + (y + 4) * w + (x+3))),
                                            *(int *) ((PRIV(src) + (y + 4) * w + (x+2))),
                                            *(int *) ((PRIV(src) + (y + 4) * w + (x+1))),
                                            *(int *) ((PRIV(src) + (y + 4) * w + (x+0))));
            __m256i I5 = _mm256_set_epi32(*(int *) ((PRIV(src) + (y + 5) * w + (x+7))),
                                            *(int *) ((PRIV(src) + (y + 5) * w + (x+6))),
                                            *(int *) ((PRIV(src) + (y + 5) * w + (x+5))),
                                            *(int *) ((PRIV(src) + (y + 5) * w + (x+4))),
                                            *(int *) ((PRIV(src) + (y + 5) * w + (x+3))),
                                            *(int *) ((PRIV(src) + (y + 5) * w + (x+2))),
                                            *(int *) ((PRIV(src) + (y + 5) * w + (x+1))),
                                            *(int *) ((PRIV(src) + (y + 5) * w + (x+0))));
            __m256i I6 = _mm256_set_epi32(*(int *) ((PRIV(src) + (y + 6) * w + (x+7))),
                                            *(int *) ((PRIV(src) + (y + 6) * w + (x+6))),
                                            *(int *) ((PRIV(src) + (y + 6) * w + (x+5))),
                                            *(int *) ((PRIV(src) + (y + 6) * w + (x+4))),
                                            *(int *) ((PRIV(src) + (y + 6) * w + (x+3))),
                                            *(int *) ((PRIV(src) + (y + 6) * w + (x+2))),
                                            *(int *) ((PRIV(src) + (y + 6) * w + (x+1))),
                                            *(int *) ((PRIV(src) + (y + 6) * w + (x+0))));
            __m256i I7 = _mm256_set_epi32(*(int *) ((PRIV(src) + (y + 7) * w + (x+7))),
                                            *(int *) ((PRIV(src) + (y + 7) * w + (x+6))),
                                            *(int *) ((PRIV(src) + (y + 7) * w + (x+5))),
                                            *(int *) ((PRIV(src) + (y + 7) * w + (x+4))),
                                            *(int *) ((PRIV(src) + (y + 7) * w + (x+3))),
                                            *(int *) ((PRIV(src) + (y + 7) * w + (x+2))),
                                            *(int *) ((PRIV(src) + (y + 7) * w + (x+1))),
                                            *(int *) ((PRIV(src) + (y + 7) * w + (x+0))));
...
MatrixAlgo AvxSetMatrixProvider = {
    .create = create,
    .assign = assign,
    .equal = equal,
    .transpose = avx_set_transpose,
    .println = println,
};
